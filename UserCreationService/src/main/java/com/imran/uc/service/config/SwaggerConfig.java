...
public class SwaggerConfig {
    ...
    public Docket api() { 
		...
		Contact contact = new Contact("IMRAN HOSSAIN", "microservice@com", "expplore247h@gmail.com");

		List<VendorExtension> vext = new ArrayList<>();
		ApiInfo apiInfo = new ApiInfo("Backend API", "", "Version 1.0", "4years", contact, "open source",
				"open source URL", vext);
	 ...
	 * 
	 * Contact contact = new Contact("IMRAN HOSSAIN", "microservice@com",
	 * "expplore247h@gmail.com");
	 * 
	 * List<VendorExtension> vext = new ArrayList<>(); ApiInfo apiInfo = new
	 * ApiInfo("Backend API", "", "Version 1.0", "4years", contact, "open source",
	 * "open source URL", vext);
	 * 
	 * Docket docket = new
