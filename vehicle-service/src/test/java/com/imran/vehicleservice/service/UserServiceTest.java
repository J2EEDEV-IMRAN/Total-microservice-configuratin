 ...
 * 
 * import com.imran.vehicleservice.exception.UserRegistrationException; import
 * com.imran.vehicleservice.model.User; import
 * com.imran.vehicleservice.repository.UserRepository;
 * 
 ...
 * org.mockito.ArgumentMatchers.any; import static org.mockito.BDDMockito.given;
 ...
 *//***
	 ...
	 *//*
		 ...
		 * 
		 * @Test void shouldSavedUserSuccessFully() { final User user = new User(null,
		 ...
		 * }
		 * 
		 * @Test void shouldThrowErrorWhenSaveUserWithExistingEmail() { final User user
		 * = new User(1L, "ten@mail.com","teten","teten");
		 * 
		 * given(userRepository.findByEmail(user.getEmail())).willReturn(Optional.of(
		 * user));
		 * 
		 ...
		 * 
		 * @Test void updateUser() { final User user = new User(1L,
		 * "ten@mail.com","teten","teten");
		 * 
		 ...
		 * 
		 * @Test void findUserById(){ final Long id = 1L; final User user = new User(1L,
		 * "ten@mail.com","teten","teten");
		 * 
		 ...
		 * }
		 * 
		 * @Test void shouldBeDelete() { final Long userId=1L;
		 * 
		 * userService.deleteUserById(userId); userService.deleteUserById(userId);
		 * 
